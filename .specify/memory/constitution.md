...
- Added sections: Artículo I–XI (Base normativa, El papel es la base legal, Nada se
  borra, Catálogo vivo historia congelada, Un dato una entrada, Aislamiento y
  portabilidad, Seguridad y acceso, Arquitectura, Calidad, Simplicidad, Software
  libre y legibilidad humana), Enmiendas (history table: 1.0.0, 2.0.0, 2.1.0)
