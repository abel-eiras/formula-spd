...
{
    public CatalogoMedicamentosWindow(IServicioMedicamentos servicio, int? usuarioActualId)
    {
        InitializeComponent();
        DataContext = new CatalogoMedicamentosViewModel(servicio, usuarioActualId);
    }
