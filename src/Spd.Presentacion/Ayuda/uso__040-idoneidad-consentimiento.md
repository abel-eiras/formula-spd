...
Siete criterios de inclusión y dos condiciones (motivación; capacidad de manejar el dispositivo) como casillas, con el texto literal del PNT. A medida que marcas, la línea **"Propuesta de la aplicación"** cambia; "Aceptar propuesta" copia ese valor al selector de resultado, que puedes cambiar. **Observaciones**: obligatorias si el resultado es NO APTO o difiere de la propuesta. "Registrar evaluación" la guarda con fecha y tu usuario; el historial se muestra debajo (la más reciente es la vigente).
