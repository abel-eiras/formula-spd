# Spec 003 — Catálogo de medicamentos

**Estado:** Borrador para revisión
**Versión:** 0.1 — 2026-09-04
**Constitución aplicable:** 2.1.0 (Artículos IV, V, VI)
**Depende de:** Ninguna funcional; Spec 000 para la URL del nomenclátor
...
| Entidad | Referencia |
|---|---|
| Medicamento, Medicamento_Hist | data-model.md |
...
|---|---|---|
| Q1 | ¿La lista cerrada de formas farmacéuticas (FR-300) necesita más valores de los listados (p. ej. "sobre", "parche")? | Ampliable sin romper nada; se define la lista completa al implementar con el propietario |
