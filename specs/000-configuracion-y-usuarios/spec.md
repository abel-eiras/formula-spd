# Feature Specification: Configuración inicial, farmacia y usuarios

**Feature Branch**: `000-configuracion-y-usuarios`
...
**Input**: Especificación completa aportada literalmente por el propietario del producto (`spec-000-configuracion-y-usuarios.md`, v0.1 — 2026-09-04). Se traslada tal cual: no se reinterpretan los requisitos, no se añaden requisitos nuevos, no se cambia la numeración FR-xxx ni los criterios de aceptación.
...
| Entidad | Referencia |
|---|---|
| Farmacia | [docs/data-model.md](../../docs/data-model.md) — una sola fila |
| Usuario, Rol | [docs/data-model.md](../../docs/data-model.md) |
